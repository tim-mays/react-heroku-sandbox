...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _LessonsPageCss = __webpack_require__(39);
  
  var _LessonsPageCss2 = _interopRequireDefault(_LessonsPageCss);
  
  var _decoratorsWithStyles = __webpack_require__(2);
  
  var _decoratorsWithStyles2 = _interopRequireDefault(_decoratorsWithStyles);
  
  var LessonsPage = (function (_Component) {
    _inherits(LessonsPage, _Component);
  
    function LessonsPage() {
      _classCallCheck(this, _LessonsPage);
  
      _get(Object.getPrototypeOf(_LessonsPage.prototype), 'constructor', this).apply(this, arguments);
    }
  
    _createClass(LessonsPage, [{
      key: 'renderPeople',
      value: function renderPeople(people) {
        console.warn('fucking here');
  
        return people.map(function (_ref) {
          var lastName = _ref.last_name;
          return _react2['default'].createElement(
            'li',
            null,
            lastName
      ...
      key: 'renderVIP',
      value: function renderVIP(_ref2) {
        var first_name = _ref2.first_name;
        var last_name = _ref2.last_name;
      ...
      value: function render() {
        ...
        var Nelson = people[0];
        var Ferguson = people[4];
  
        return _react2['default'].createElement(
          'div',
          { className: 'LessonsPage' },
          _react2['default'].createElement(
            'div',
            { className: 'LessonsPage-container' },
            this.props.path === '/' ? null : _react2['default'].createElement(
              'h1',
              null,
              this.props.title
    ...
    var _LessonsPage = LessonsPage;
    LessonsPage = (0, _decoratorsWithStyles2['default'])(_LessonsPageCss2['default'])(LessonsPage) || LessonsPage;
    return LessonsPage;
  })(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsLessonsPage = __webpack_require__(20);
  
  var _componentsLessonsPage2 = _interopRequireDefault(_componentsLessonsPage);
  ...
  var router = new _reactRoutingSrcRouter2['default'](function (on) {
    ...
    on('/lessons', function callee$1$0() {
      return regeneratorRuntime.async(function callee$1$0$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            return context$2$0.abrupt('return', _react2['default'].createElement(_componentsLessonsPage2['default'], null));
